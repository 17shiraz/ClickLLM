...
def main(dataset, model_name, openai_api_key=None):
    ...
    for year in dataset:
        ...
        # === Config ===
        pkl_path = f'/mnt/data/msaliminabi/CLickLLM/data/triples.run.queries.train.{year}.bm25.top1000.tsv.pkl'
        abstract_path = f'/mnt/data/msaliminabi/ClickLLM/data/LaQuE_collection.tsv'
        ...
        for qid in qid_list:
            ...
            for docid in pos_entities:
                ...
                with open(f'laque_{model_name}_abstract.txt', 'a') as output:
